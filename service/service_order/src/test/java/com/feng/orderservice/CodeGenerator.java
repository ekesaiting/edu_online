...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\shf\\Desktop\\projects\\online_edu_parent\\service\\service_order" + "/src/main/java");
        gc.setAuthor("shf");
        ...
        pc.setModuleName("orderservice");//设置模块
        ...
        strategy.setInclude("t_order","t_pay_log"); // 设置要映射的表名,接受参数可变，可以多张表

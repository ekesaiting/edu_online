...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\shf\\Desktop\\projects\\online_edu_parent\\service\\service_edu" + "/src/main/java");
        gc.setAuthor("shf");
        ...
        pc.setModuleName("eduservice");//设置模块
        ...
        strategy.setInclude("edu_course","edu_course_description","edu_chapter","edu_video"); // 设置要映射的表名,接受参数可变，可以多张表

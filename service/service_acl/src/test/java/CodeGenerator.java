...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\shf\\Desktop\\projects\\online_edu_parent\\service\\service_acl" + "/src/main/java");
        gc.setAuthor("shf");
        ...
        pc.setModuleName("aclservice");//设置模块
        ...
        strategy.setInclude("acl_role_permission","acl_user_role"); // 设置要映射的表名,接受参数可变，可以多张表

...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\shf\\Desktop\\projects\\online_edu_parent\\service\\service_cms" + "/src/main/java");
        gc.setAuthor("shf");
        ...
        pc.setModuleName("cmsservice");//设置模块
        ...
        strategy.setInclude("crm_banner"); // 设置要映射的表名,接受参数可变，可以多张表
